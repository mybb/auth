...
class EloquentUserProvider extends LaravelUser
{
	 ...
	 *
	 * @param  \Illuminate\Contracts\Auth\Authenticatable  $user - We need to use Laravel's Interface to overwrite the method properly, however it should be an instance of MyBB\Auth\Contracts\UserContract (checked in the method)
